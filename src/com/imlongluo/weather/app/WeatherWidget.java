...
public class WeatherWidget extends AppWidgetProvider {
	...
	public static void updateAppWidget(RemoteViews views, Context context,
		...
		SharedPreferences shared = context.getSharedPreferences(
				MainActivity.STORE_WEATHER, MainActivity.MODE_PRIVATE);
	...
	public static void updateWeather(RemoteViews views, Context context) {
		...
		views.setImageViewResource(R.id.widget_icon,
				sp.getInt("img_title1", R.drawable.weathericon_condition_17));
	}
	...
	public static void updateWeather(RemoteViews views, Context context,
		...
		str.append(".html");
		try {
			String info = new WebAccessTools(context).getWebContent(str
					.toString());
